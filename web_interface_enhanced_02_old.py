...
def get_available_model_ids() -> List[Dict[str, Any]]:
    ...
    try:
        ...
        # Simpler query - just from CONTRACT table
        query = """
        SELECT 
            c.MODEL_ID,
        ...
        print(f"Executing query to fetch model IDs...")
        ...
        if len(models) == 0:
            error_msg = "No model IDs found in CONTRACT table. Check if MODEL_ID column has values."
