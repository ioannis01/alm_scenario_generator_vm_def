            ...
            <div class="grid">
                <div class="card">
                    ...
                    <div style="background: rgba(20, 184, 166, 0.05); border: 1px solid rgba(20, 184, 166, 0.2); border-radius: 10px; padding: 1.5rem; margin-bottom: 1.5rem;">
                        ...
                        <div style="background: rgba(20, 184, 166, 0.1); border: 1px solid rgba(20, 184, 166, 0.2); padding: 1rem; border-radius: 8px; color: var(--primary); text-align: center;">
                            <strong>ℹ️ Data Configuration Only</strong><br>
                            <span style="font-size: 0.875rem;">Configure your Model ID and limits here. Data will be loaded automatically when you click "Generate Scenarios" in the Generate tab.</span>
                        </div>
                    </div>
                ...
                <div class="status-panel">
                    ...
                    <div class="status-card">
                        ...
                        <div style="font-size: 0.875rem; color: var(--muted); line-height: 1.6;">
                            <p style="margin-bottom: 0.75rem;"><strong style="color: var(--foreground);">Step 1:</strong> Enter a Model ID (optional - leave empty for all)</p>
                            <p style="margin-bottom: 0.75rem;"><strong style="color: var(--foreground);">Step 2:</strong> Configure record limit (optional)</p>
                            <p style="margin-bottom: 0;"><strong style="color: var(--foreground);">Step 3:</strong> Go to Generate tab and click "Generate Scenarios"</p>
                        </div>
                    </div>
                </div>
            </div>
